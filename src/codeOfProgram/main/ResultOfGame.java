...
//            writeResultToFile.saveResult(nickname, countOfPoints);
    ...
    public boolean countResultAfterUserStop(String nickname, int countOfPoints, List<String> result, boolean takeNewCard, boolean endOfGame) {
        if (!takeNewCard&&!endOfGame){
            if (countOfPoints < 18) {
